...
@section('title', 'New Incoming Transaction')

@section('page-header')
    <div class="flex flex-col">
        <h1 class="text-base font-semibold text-slate-900">New incoming transaction</h1>
        <p class="text-xs text-slate-500">
            Catat barang masuk dari supplier. Stok akan diperbarui setelah verifikasi di tahap berikutnya.
        </p>
    </div>
            ...
            >
                ...
                <div class="space-y-1 mt-4">
                    ...
                    <textarea
                        ...
                        rows="2"
                        class="w-full rounded-lg border border-slate-200 px-3 py-2 text-[11px]"
                        placeholder="Optional notes about this incoming transaction."
                    >{{ old('notes') }}</textarea>
                </div>
