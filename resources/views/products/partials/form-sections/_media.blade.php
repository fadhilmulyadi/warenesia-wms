<div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
    ...
    <div class="relative w-full aspect-square rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 hover:bg-slate-100 transition flex flex-col items-center justify-center text-center cursor-pointer overflow-hidden group">
        <input type="file" name="image" accept="image/*" class="absolute inset-0 w-full h-full opacity-0 z-10 cursor-pointer" @change="handleImage">
        
        {{-- Default State --}}
        <div x-show="!imagePreview" class="p-4">
            <div class="mx-auto w-12 h-12 bg-white rounded-full shadow-sm border border-slate-200 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
