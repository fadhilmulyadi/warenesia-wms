...
<div class="w-full py-6">
    <ol class="items-center sm:flex w-full">
        ...
        @foreach ($steps as $stepKey => $stepData)
            @php
                ...
                if ($isCancelled) {
                    $dotColor = 'bg-red-100 text-red-700'; $ringColor = 'sm:ring-8 sm:ring-red-200'; $lineColor = 'bg-red-200'; $textColor = 'text-red-700';
                } elseif ($index < $currentIndex) {
                    $dotColor = 'bg-teal-600 text-white'; $ringColor = 'sm:ring-8 sm:ring-teal-300'; $lineColor = 'bg-teal-600'; $textColor = 'text-teal-700';
                } elseif ($isCurrent) {
                    $dotColor = 'bg-white text-teal-600 border border-teal-600'; $ringColor = 'sm:ring-8 sm:ring-teal-100'; $lineColor = 'bg-gray-200'; $textColor = 'text-teal-700';
                } else {
                    $dotColor = 'bg-gray-200 text-gray-500 border border-gray-300'; $ringColor = 'sm:ring-8 sm:ring-gray-100'; $lineColor = 'bg-gray-200'; $textColor = 'text-gray-500';
                }
            @endphp
            ...
            <li class="relative mb-8 sm:mb-0 flex-1">
                ...
                <div class="relative z-10 flex flex-col items-center">
                    ...
                    {{-- Dot --}}
                    <div class="flex items-center justify-center w-6 h-6 rounded-full {{ $dotColor }} {{ $ringColor }} shrink-0">
                        @if ($isCompleted)
    ...
    @if ($isCancelled)
        <div class="mt-8 mx-auto max-w-lg bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg flex items-center gap-3 shadow-sm">
