        ...
        >
            ...
            <div class="shrink-0">
                <template x-if="toast.type === 'success'">
                    <div class="inline-flex h-8 w-8 items-center justify-center rounded-full bg-emerald-100 text-emerald-500">
            ...
            {{-- Text --}}
            <div class="flex-1">
                <p class="text-sm font-semibold text-slate-900" x-text="toast.type === 'success' ? 'Berhasil!' : 'Gagal!'"></p>
