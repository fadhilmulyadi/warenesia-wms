    ...
    @if($canManageCategories && !$isReadOnly)
        ...
        >
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-5 text-xs">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        ...
                        <p class="text-[11px] text-slate-500">
                            Create a new category without leaving the product form.
                        </p>
                    </div>
                    <button
                        type="button"
                ...
                <form method="POST" action="{{ route('admin.categories.quick-store') }}" class="space-y-3">
                    @csrf
                    ...
                    <p class="text-[10px] text-slate-400">
                        This popup is only for quickly creating a new category.
                        For full category management (list, edit, delete), use the Categories page.
                    </p>

                    <div class="mt-1">
                        <a
                            href="{{ route('admin.categories.index') }}"
                            class="inline-flex items-center gap-1 text-[10px] text-teal-600 hover:text-teal-700"
                        >
                            <x-lucide-external-link class="h-3 w-3" />
                            <span>Open Categories page</span>
                        </a>
                    </div>
                    ...
                    <div class="flex justify-end gap-2 pt-2">
                        ...
                        <button
                            type="submit"
                            class="px-3 py-1.5 rounded-lg text-[11px] font-semibold bg-teal-500 text-white hover:bg-teal-600"
                        >
                            Save category
                        </button>
                    </div>
