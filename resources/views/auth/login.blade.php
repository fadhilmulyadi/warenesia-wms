<x-guest-layout>
    ...
    <div class="flex min-h-screen w-full bg-slate-50 overflow-hidden font-sans"
        ...
        <div class="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden bg-gray-900">
            ...
            <img src="{{ asset('images/login-hero.png') }}" alt="Warehouse Background"
            ...
            <div class="relative z-10 p-12 text-white max-w-lg">
                <div
                    class="mb-6 bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20 shadow-lg">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative">
            ...
            <div class="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
                ...
                <div class="mb-8">
                    ...
                    <p class="hidden md:block text-slate-500 text-sm">Masuk ke dashboard Warenesia untuk melanjutkan.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <button type="submit"
                        class="w-full flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
                        <span>Masuk</span>
                    ...
                    <div class="text-center space-y-2">
                        <p class="text-sm text-slate-600">
                            ...
                            <a href="{{ route('supplier.register') }}"
                                class="font-bold text-teal-600 hover:text-teal-700 hover:underline transition-colors">
                                Daftar Supplier
                            </a>
                        </p>
                    </div>
