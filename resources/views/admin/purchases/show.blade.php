            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-3 mb-2 flex flex-wrap items-center justify-between gap-2 text-xs">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    @if($purchase->canBeVerified())
                        ...
                        <form
                            method="POST"
                            action="{{ route('admin.purchases.verify', $purchase) }}"
                        ...
                        <form
                            method="POST"
                            action="{{ route('admin.purchases.reject', $purchase) }}"
                    ...
                    @elseif($purchase->canBeCompleted())
                        {{-- Mark Completed --}}
                        <form
                            method="POST"
                            action="{{ route('admin.purchases.complete', $purchase) }}"
