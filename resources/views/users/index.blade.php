...
@section('page-header')
    <x-page-header
        ...
        description="Kelola seluruh pengguna sistem."
    />
@endsection
...
@section('content')
    <div class="space-y-4 max-w-6xl mx-auto">
        ...
        <x-toolbar>
            ...
            <x-filter-bar
                :action="route('users.index', ['per_page' => $perPage])"
                :search="$search"
                :sort="$sort"
                :direction="$direction"
                :filters="$filters"
            ...
            >
                <x-slot:filter_role>
                    <x-filter.checkbox-list
                        name="role"
                        :columns="2"
                        :options="collect($roles)->map(fn ($label, $value) => ['value' => $value, 'label' => $label])"
                        :selected="$roleFilter"
                    />
                </x-slot:filter_role>
                ...
                <x-slot:filter_status>
                    <x-filter.checkbox-list
                        name="status"
                        :columns="2"
                        :options="collect($statuses)->map(fn ($label, $value) => ['value' => $value, 'label' => $label])"
